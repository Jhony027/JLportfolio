...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    document.getElementById('darkModeToggle').addEventListener('click', function() {
      ...
      // Add the transitioning class to enable the animation
      this.classList.add('transitioning');
    
      // Remove the transitioning class and moon class after the animation completes
      setTimeout(() => {
        this.classList.remove('transitioning', 'moon');
